...
const DBC toyota_nodsu_hybrid_pt_generated_corollah_tss2 = {
  .name = "toyota_nodsu_hybrid_pt_generated_corollah_tss2",
...
dbc_init(toyota_nodsu_hybrid_pt_generated_corollah_tss2)