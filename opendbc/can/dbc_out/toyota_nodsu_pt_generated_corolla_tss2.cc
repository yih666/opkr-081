...
const DBC toyota_nodsu_pt_generated_corolla_tss2 = {
  .name = "toyota_nodsu_pt_generated_corolla_tss2",
...
dbc_init(toyota_nodsu_pt_generated_corolla_tss2)